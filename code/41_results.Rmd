...
compute_ESE_metrics <- function(
  ...
  # ---- Stage 1: Rep-level → scenario-level summary ----
  stage1 <- all_df_gamma |>
    ...
    summarise(
      ...
      # Estimate distribution descriptives
...
ese_by_treatment <- compute_ESE_metrics(
  group_vars = "treatment_fct")

ese_by_scenario  <- compute_ESE_metrics(
  group_vars = c("treatment_fct", "nobs_fct", "prop_extreme_fct", "magnitude_fct"))
```
