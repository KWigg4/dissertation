...
Version 10-16-2025:   
 ...
 - Updated gamma shape to 2 (from 5)  
 - Changed coefficients to match 20_emp_analysis.Rmd output
...
simulate_panel_data <- function(
  ...
  gamma_shape = 0.5 # changed from 5
) {
  T <- 2; N <- n * T
  ids <- rep(1:n, each = T)
...
# --- Export to CSV ---
write.csv(summ_grid, paste0("MC_results_108scenarios_",dt,".csv"))
